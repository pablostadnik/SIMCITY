                ...
                <div class="carousel-inner">
                  <div class="item active">
                    ...
                    <div class="carousel-caption">
                      <h4 id="fecha1">26/07/2013</h4>
                      <p id="descripcion1">Vivi en Sincity la fiesta del descontrolado, comprate 3 tragos y pagas solo 1, esto solo te los puede dar Sincity, no te lo podes perder</p>
                    </div>
                  </div>
                  <div class="item">
                    <img style="width:700px;height:400px;" src="eventos/2.jpg" alt="">
                    <div class="carousel-caption">
                      <h4 id="fecha2">27/07/2013</h4>
                      <p id="descripcion2">La fiesta de la pulsera: Compras en las barras las pulseras que desees y luego las canjeas por besos con las chicas. Ellas luego canjean sus pulseras por trago</p>
                    </div>
                  </div>
                  <div class="item">
                    <img style="width:700px;height:400px;" src="eventos/3.jpg" alt="">
                    <div class="carousel-caption">
                      <h4 id="fecha3">28/07/2013</h4>
                      <p id="descripcion3">Fiesta del tequila: Comrate un tequila en la barra y te regalamos otra mas. Tambien un show de mexicanos para que puedas disfrutar su baile nocturno</p>
                    </div>
                  </div>
                </div>
